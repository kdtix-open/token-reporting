...
## Projectit production invariant

For `dev.projectit.ai`, never use bare `npm run build` during publish, recycle, reboot
recovery, or a LaunchAgent/systemd reinstall. Use
