...
| Lint | `npm run lint` |
| Fetch Claude data | `ANTHROPIC_ADMIN_API_KEY=sk-ant-admin... npm run report:claude` |
| Fetch Cursor data | `CURSOR_ADMIN_API_KEY=... npm run report:cursor` |
| Fetch Copilot data | `GITHUB_TOKEN=... GITHUB_ORG=kdtix-open npm run report:copilot` |
| Fetch Codex data | `OPENAI_API_KEY=... npm run report:codex` |
